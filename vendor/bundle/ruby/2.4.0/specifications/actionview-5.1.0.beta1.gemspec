# -*- encoding: utf-8 -*-
# stub: actionview 5.1.0.beta1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<actionpack>.freeze, ["= 5.1.0.beta1"])
      s.add_development_dependency(%q<activemodel>.freeze, ["= 5.1.0.beta1"])
    else
